// src/features/services/ui/templates/WebsiteTemplate.tsx
...
export default function WebsiteTemplate({ data, locale }: ServiceDetailViewProps) {
  ...
  const serviceKey = (data.key ?? "website") as ServiceKey;
