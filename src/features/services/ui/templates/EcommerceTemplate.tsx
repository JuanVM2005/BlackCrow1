// src/features/services/ui/templates/EcommerceTemplate.tsx
...
export default function EcommerceTemplate({ data, locale }: ServiceDetailViewProps) {
  ...
  const serviceKey = (data.key ?? "ecommerce") as ServiceKey;
